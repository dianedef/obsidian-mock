...
export const parseFrontMatterAliases = vi.fn((frontmatter) => {
    if (!frontmatter)
        return null;
...
export const parseFrontMatterEntry = vi.fn((frontmatter, key) => {
    if (!frontmatter)
        return null;
...
export const parseFrontMatterStringArray = vi.fn((frontmatter, key, nospaces = false) => {
...
export const parseFrontMatterTags = vi.fn((frontmatter) => {
    if (!frontmatter)
        return null;
